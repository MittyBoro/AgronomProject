<main class="home-page">
  ...
  <section class="home__section">
    <div class="home__container container">
      <div class="home__content">
        <img
          class="home__image object-cover"
          src="{{ Vite::front('images/home-background.png') }}"
          alt=""
        />
        <div class="home__text white-blur-block">
          ...
          <a class="button home__button" href="/catalog" wire:navigate>
            Перейти в каталог
          </a>
        </div>
      </div>
  ...
  <x-product.list
    ...
    pretitle="Лучшее за месяц"
    :button="['/catalog', 'В каталог']"
  />

  {{-- Категории, swiper --}}
  <livewire:lists.category-list
  ...
  <section class="about__section">
    <div class="about__container container">
      ...
      <div class="about__text">
        ...
        <a class="button about__button" href="/about" wire:navigate>
          Узнать больше
        </a>
      </div>
    </div>
  ...
  {{-- Статьи --}}
  <x-article.list
    title="Программы подкормок"
    :articles="$articles"
    pretitle="Полезное"
    :button="['/articles', 'Больше статей']"
  />
