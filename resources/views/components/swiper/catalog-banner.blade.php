<swiper-container class="catalog-banner__slider" pagination="true"
  pagination-clickable="true" space-between="30px" autoplay="true"
  autoplay-pause-on-mouse-enter="true" mousewheel="true"
  mousewheel-force-to-axis="true" loop="true" delay="5000" keyboard="true">
  @foreach (range(1, 7) as $banner)
    <swiper-slide>
      <div class="catalog-banner">
        <img class="object-cover"
          src="{{ Vite::front('images/catalog-banner-demo.png') }}"
