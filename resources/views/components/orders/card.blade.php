  ...
  <div class="account-order__body">
    <div class="account-order__info">
      ...
      <div class="account-order__info-line">
        <div class="account-order__info-title">Способ доставки</div>
        <div class="account-order__info-text">Самовывоз</div>
      </div>
      <div class="account-order__info-line">
        <div class="account-order__info-title">Способ оплаты</div>
        <div class="account-order__info-text">Наличные</div>
      </div>
      <div class="account-order__info-line">
        <div class="account-order__info-title">Стоимость доставки</div>
        <div class="account-order__info-text">Бесплатно</div>
      </div>
      <div class="account-order__info-line">
        <div class="account-order__info-title">Скидка</div>
        <div class="account-order__info-text">-500 руб.</div>
      </div>
      <div class="account-order__info-line">
        <div class="account-order__info-title">Начально бонусов</div>
        <div class="account-order__info-text primary"><b>15</b></div>
      </div>
      <div class="account-order__info-line">
        <div class="account-order__info-title">Сумма заказа</div>
        <div class="account-order__info-text"><b>2 000 руб.</b></div>
      </div>
    </div>
    <div class="account-order__info">
      <div class="account-order__info-header">Контактное лицо</div>
      <div class="account-order__info-line">
        <div class="account-order__info-title">Контактное лицо</div>
        <div class="account-order__info-text">Иванов Иван Иванович</div>
      </div>
      <div class="account-order__info-line">
        <div class="account-order__info-title">Телефон</div>
      ...
      <div class="account-order__info-line">
        <div class="account-order__info-title">Адрес доставки</div>
        <div class="account-order__info-text">Москва, ул. Ленина, д. 1</div>
      </div>
    </div>
